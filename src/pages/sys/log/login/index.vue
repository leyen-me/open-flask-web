<template>
  <el-card>
    <el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
      ...
      <el-form-item>
        <BaseSelect v-model="state.queryForm.status" dict-type="success_fail" placeholder="登录状态"
    ...
    <el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%"
      ...
      <el-table-column prop="user_agent" label="User Agent" show-overflow-tooltip header-align="center"
      ...
      <el-table-column prop="create_time" label="登录时间" header-align="center" align="center"
...
const downloadExcel = () => {
  const down = useDownload({url: '/sys/log/login/export', method: 'GET'})
  down()
}
</script>
