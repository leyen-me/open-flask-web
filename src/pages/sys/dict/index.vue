<template>
  <el-card>
    ...
    >
      ...
      <el-table-column prop="sort" label="排序" sortable="custom" header-align="center"
                       align="center"></el-table-column>
      <el-table-column prop="create_time" label="创建时间" header-align="center" align="center"
                       width="180"></el-table-column>
      <el-table-column label="操作" fixed="right" header-align="center" align="center" width="200">
        <template #default="scope">
          <el-button v-if="scope.row.dict_source === 0" type="primary" link @click="showDictDataHandle(scope.row)">
            字典配置
          </el-button>
          <el-button v-if="scope.row.dict_source === 1" type="primary" link @click="showDataSqlHandle(scope.row)">
            动态数据
          </el-button>
    ...
    <!-- 动态数据 -->
    <el-drawer v-if="dataSqlVisible" v-model="dataSqlVisible" :title="dataSqlTitle" :size="800"
               :close-on-press-escape="false">
      <data-sql :dict-type-id="dict_type_id"></data-sql>
    </el-drawer>

    <!-- 字典配置 -->
    <el-drawer v-if="dictDataVisible" v-model="dictDataVisible" :title="dictDataTitle" :size="800"
               :close-on-press-escape="false">
