<template>
  <el-card>
    <el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
      ...
      <el-form-item>
        <BaseSelect v-model="state.queryForm.param_type" dict-type="params_type" placeholder="系统参数"
                    clearable></BaseSelect>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%"
      ...
      <el-table-column prop="param_name" label="参数名称" show-overflow-tooltip header-align="center"
                       align="center"></el-table-column>
      <el-table-column prop="param_key" label="参数键" show-overflow-tooltip header-align="center"
                       align="center"></el-table-column>
      <el-table-column prop="param_value" label="参数值" show-overflow-tooltip header-align="center"
                       align="center"></el-table-column>
